...
struct Strings{
    ...
    let defaultBottomTitleLabelArray = ["#요즘_부모님들_이거_좋아해", "#내돈내산하기_아까운_아이템", "#훈훈함_장착가능_아이템", "#내돈내산_절대_안함" , "#더우니_시원한_선물ㄱㄱ"]
    let defaultTop5LabelArray = "이런 선물은 어때요?"
    let defaultContentsLabelArray = ["#만족_100프로_부모님선물","#친구가_좋아할_만한선물","#친구에게_가장_필요한_선물","#내친구에게_찰떡_아이템ㅋㅋ","#HOT_여름_필수템"]
